...
export default function TrainingCalendar(){
  ...
  return <section className="section calendar-section" id="calendar">
    <div className="mobile-calendar-head"><div><span>訓練日程</span><strong>{item.date.getFullYear()} 年 {item.date.getMonth()+1} 月</strong></div><button onClick={()=>choose(0)} disabled={selected===0}>今天</button></div>
