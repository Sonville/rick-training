...
{name:'啞鈴彎舉',target:'肱二頭肌',setup:'站姿或坐姿靠穩，雙腳踩穩；掌心朝前，手肘貼近身體。',do:'固定上臂，以手肘彎曲把啞鈴帶向肩膀；頂端收緊，再用2–3秒控制下放。',feel:'二頭肌收縮與伸展，手腕保持直，身體不需要晃動。',avoid:'後仰甩重、手肘前移、手腕折彎或為了重量縮短下放幅度。'},
{name:'牧師椅彎舉',target:'肱二頭肌、肱肌',setup:'調整座椅讓腋下與上臂貼穩墊子，肘關節對準機器轉軸；胸口靠近支撐。',do:'固定上臂，只做手肘彎曲；向上收緊，回程慢慢放到接近伸直但不彈、不鎖死。',feel:'二頭肌持續受力，尤其是下放接近底端時；肩膀不應該代償。',avoid:'底端反彈、讓手肘離墊、用肩膀帶動或使用無法控制的重量。'},
